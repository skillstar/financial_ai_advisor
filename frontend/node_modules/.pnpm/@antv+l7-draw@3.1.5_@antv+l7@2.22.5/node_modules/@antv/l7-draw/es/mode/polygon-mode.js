...
import { booleanClockwise, coordAll, featureCollection, lineString } from '@turf/turf';
import { cloneDeep, first, isEqual, last } from 'lodash';
import { DEFAULT_AREA_OPTIONS, DrawEvent, RenderEvent } from '../constant';
import { calcAreaText, createPointFeature, createPolygonFeature, getPosition, isSameFeature, joinMultiFeatures, updateTargetFeature } from '../utils';
import { LineMode } from './line-mode';
import { DEFAULT_POLYGON_HELPER_CONFIG } from '../constant/helper';
export var PolygonMode = /*#__PURE__*/function (_LineMode) {
  ...
  return _createClass(PolygonMode, [{
    ...
    value: function getDefaultOptions(options) {
      ...
      if (options.areaOptions) {
        newOptions.areaOptions = _objectSpread(_objectSpread({}, DEFAULT_AREA_OPTIONS), options.areaOptions);
      }
      return newOptions;
    }
  }, {
    ...
    value: function bindPolygonRenderEvent() {
      ...
      (_this$polygonRender = this.polygonRender) === null || _this$polygonRender === void 0 ? void 0 : _this$polygonRender.on(RenderEvent.UnClick, this.onPolygonUnClick.bind(this));
      (_this$polygonRender2 = this.polygonRender) === null || _this$polygonRender2 === void 0 ? void 0 : _this$polygonRender2.on(RenderEvent.Mousemove, this.onPolygonHover.bind(this));
      (_this$polygonRender3 = this.polygonRender) === null || _this$polygonRender3 === void 0 ? void 0 : _this$polygonRender3.on(RenderEvent.Mouseout, this.onPolygonUnHover.bind(this));
      (_this$polygonRender4 = this.polygonRender) === null || _this$polygonRender4 === void 0 ? void 0 : _this$polygonRender4.on(RenderEvent.Dragstart, this.onPolygonDragStart.bind(this));
    ...
    value: function syncPolygonNodes(polygon, nodes) {
      ...
      if (!isSameFeature(this.drawPolygon, polygon)) {
        ...
        var lastNode = last(newLineNodes);
        if (!isEqual(firstNode.geometry.coordinates, lastNode.geometry.coordinates)) {
          lastNode.geometry.coordinates = cloneDeep(firstNode.geometry.coordinates);
        }
