...
var NetworkGraph_exports = {};
__export(NetworkGraph_exports, {
  default: () => NetworkGraph_default
});
module.exports = __toCommonJS(NetworkGraph_exports);
...
var NetworkGraph = (props) => {
  ...
  const config = (0, import_hooks.useGraphConfig)("NetworkGraph", defaultConfig, restProps);
  return /* @__PURE__ */ import_react.default.createElement(import_graphs.NetworkGraph, { data, ...config });
};
