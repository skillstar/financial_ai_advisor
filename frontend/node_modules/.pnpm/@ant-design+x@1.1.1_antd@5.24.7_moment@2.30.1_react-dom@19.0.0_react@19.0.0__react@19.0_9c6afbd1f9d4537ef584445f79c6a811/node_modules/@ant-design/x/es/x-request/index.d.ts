...
declare class XRequestClass {
    ...
    create: <Input = AnyObject, Output = Partial<Record<import("../x-stream").SSEFields, any>>>(params: XRequestParams & Input, callbacks?: XRequestCallbacks<Output> | undefined, transformStream?: TransformStream<string, Output> | undefined) => Promise<void>;
