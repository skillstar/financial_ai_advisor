...
export type ILineDrawerOptions = ILineModeOptions<Feature<LineString | MultiLineString>>;
export declare class LineDrawer extends LineMode<ILineDrawerOptions> {
    ...
    setData(lines: Feature<LineString | MultiLineString>[]): void;
    getData(getOriginData?: boolean): ILineFeature[];
