...
const ZoomControl = ({
  ...
  const {
    portal: zoomInTextPortal,
    dom: zoomInTextDOM
  } = (0, _hooks2.useL7ComponentPortal)(zoomInText);
  const {
    portal: zoomOutTextPortal,
    dom: zoomOutTextDOM
  } = (0, _hooks2.useL7ComponentPortal)(zoomOutText);
  ...
  (0, _react.useEffect)(() => {
    const zoom = new _l.Zoom((0, _lodash.omitBy)(controlOptions, value => value === undefined));
    setControl(zoom);
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, zoomInTextPortal, zoomOutTextPortal);
};
