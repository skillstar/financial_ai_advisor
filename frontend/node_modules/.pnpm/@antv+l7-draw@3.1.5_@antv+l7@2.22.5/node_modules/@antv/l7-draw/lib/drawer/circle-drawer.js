...
var CircleDrawer = exports.CircleDrawer = /*#__PURE__*/function (_DragPolygonMode) {
  ...
  return _createClass(CircleDrawer, [{
    ...
    value: function getDefaultOptions(options) {
      ...
      if (newOptions.helper) {
        newOptions.helper = _objectSpread(_objectSpread({}, newOptions.helper), _helper.DEFAULT_CIRCLE_HELPER_CONFIG);
      }
      return newOptions;
    }
  }, {
    ...
    value: function setData(data) {
      ...
      var result = data.map(function (feature) {
        ...
        feature.properties = _objectSpread(_objectSpread({}, (0, _utils.getDefaultPolygonProperties)()), feature.properties);
        ...
        if (((_nodes = nodes) === null || _nodes === void 0 ? void 0 : _nodes.length) !== 2) {
          var _center$geometry$coor = _slicedToArray((0, _turf.center)(feature).geometry.coordinates, 2),
            lng1 = _center$geometry$coor[0],
            lat1 = _center$geometry$coor[1];
          var box = (0, _turf.bbox)(feature);
          var lng2 = box[2];
    ...
    value: function onLineDragging(e) {
      ...
      if (dragPolygon) {
        var _getPosition = (0, _utils.getPosition)(e),
        ...
        nodes.forEach(function (node) {
          ...
          node.geometry.coordinates = [(0, _utils.getPrecisionNumber)(lng + curLng - preLng), (0, _utils.getPrecisionNumber)(lat + curLat - preLat)];
        });
    ...
    value: function getBoundaryPositions(startPoint, endPoint) {
      ...
      var dis = (0, _turf.distance)(startPoint, endPoint, {
        units: 'meters'
      });
      var positions = [];
      for (var i = 0; i < steps; i++) {
        positions.push((0, _turf.destination)(startPoint, dis, i * -360 / steps, {
          units: 'meters'
        }).geometry.coordinates.map(function (item) {
          return (0, _utils.getPrecisionNumber)(item, 6);
        }));
      }
