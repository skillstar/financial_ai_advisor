...
export var useLayerList = function useLayerList() {
  var layerManager = useLayerManager();
  var _useState = useState((layerManager === null || layerManager === void 0 ? void 0 : layerManager.getLayers()) || []),
    _useState2 = _slicedToArray(_useState, 2),
    layerList = _useState2[0],
    setLayerList = _useState2[1];
  useEffect(function () {
    if (layerManager) {
      var onUpdateLayerList = function onUpdateLayerList() {
