...
export var MidPointMode = /*#__PURE__*/function (_PointMode) {
  ...
  return _createClass(MidPointMode, [{
    ...
    value: function bindMidPointRenderEvent() {
      ...
      (_this$midPointRender = this.midPointRender) === null || _this$midPointRender === void 0 ? void 0 : _this$midPointRender.on(RenderEvent.Click, this.onMidPointClick.bind(this));
      (_this$midPointRender2 = this.midPointRender) === null || _this$midPointRender2 === void 0 ? void 0 : _this$midPointRender2.on(RenderEvent.Mousemove, this.onMidPointHover.bind(this));
      (_this$midPointRender3 = this.midPointRender) === null || _this$midPointRender3 === void 0 ? void 0 : _this$midPointRender3.on(RenderEvent.Mouseout, this.onMidPointUnHover.bind(this));
    }
    /**
     * 获取中点数据
     */
