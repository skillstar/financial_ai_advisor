...
exports.ExportImageControl = void 0;
...
const ExportImageControl = ({
  ...
  (0, _react.useEffect)(() => {
    const exportImage = new _l.ExportImage((0, _lodash.omitBy)(controlOptions, value => value === undefined));
...
exports.ExportImageControl = ExportImageControl;