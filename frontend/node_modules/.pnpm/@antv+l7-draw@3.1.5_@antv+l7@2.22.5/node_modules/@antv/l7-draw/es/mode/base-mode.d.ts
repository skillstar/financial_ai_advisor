...
export declare abstract class BaseMode<O extends IBaseModeOptions = IBaseModeOptions> extends EventEmitter<DrawEvent | keyof typeof DrawEvent> {
    ...
    getTargetFeature(target: Feature | string | null | undefined, data?: Feature<import("@turf/turf").Geometry | import("@turf/turf").GeometryCollection, import("@turf/turf").Properties>[]): IBaseFeature<import("@turf/turf").Geometry, import("../typings").IBaseProperties> | null;
    abstract setActiveFeature(target: Feature | string | null | undefined): void;
    abstract resetFeatures(): void;
    /**
     * 删除当前active的绘制物
     */
    removeActiveFeature(): Feature<import("@turf/turf").Geometry | import("@turf/turf").GeometryCollection, import("@turf/turf").Properties> | undefined;
    /**
     * 删除指定
     * @param target
     */
