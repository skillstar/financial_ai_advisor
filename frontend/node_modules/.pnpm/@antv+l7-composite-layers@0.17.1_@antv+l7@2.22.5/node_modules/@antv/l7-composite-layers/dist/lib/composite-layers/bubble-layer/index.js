...
class BubbleLayer extends composite_layer_1.CompositeLayer {
    /**
     * 主图层
     */
    get layer() {
    ...
    constructor(options) {
         ...
         * 复合图层类型
         */
        this.type = composite_layer_1.CompositeLayer.LayerType.BubbleLayer;
        /**
         * 选中数据
         */
        this.selectData = [];
    ...
    createSubLayers() {
        ...
        // 映射填充图层
        const fillLayer = new point_layer_1.PointLayer(Object.assign(Object.assign({}, this.getFillLayerOptions()), { id: 'fillLayer', shape: 'circle', source, interaction: true }));
        // 高亮描边图层
        const highlightStrokeLayer = new point_layer_1.PointLayer(Object.assign(Object.assign({}, this.getHighlightStrokeLayerOptions()), { id: 'highlightStrokeLayer', shape: 'circle' }));
        // 选中填充图层
        const selectFillLayer = new point_layer_1.PointLayer(Object.assign(Object.assign({}, this.getSelectFillLayerOptions()), { id: 'selectFillLayer', shape: 'circle' }));
        // 选中描边图层
        const selectStrokeLayer = new point_layer_1.PointLayer(Object.assign(Object.assign({}, this.getSelectStrokeLayerOptions()), { id: 'selectStrokeLayer', shape: 'circle' }));
        // 标注图层
        const labelLayer = new text_layer_1.TextLayer(Object.assign(Object.assign({}, (0, label_layer_1.getLabelLayerOptions)(this.options)), { id: 'labelLayer', source }));
     ...
     */
    getFillLayerOptions() {
        const _a = (0, util_1.omit)(this.options, ['source']), { visible, minZoom, maxZoom, zIndex = 0, fillColor, radius, opacity, strokeColor, lineOpacity, lineWidth } = _a, baseConfig = tslib_1.__rest(_a, ["visible", "minZoom", "maxZoom", "zIndex", "fillColor", "radius", "opacity", "strokeColor", "lineOpacity", "lineWidth"]);
        ...
        const fillStyle = {
            opacity: opacity,
            stroke: strokeColor,
            strokeOpacity: (0, util_1.isUndefined)(lineOpacity) ? opacity : lineOpacity,
    ...
    getHighlightStrokeLayerOptions() {
        ...
        const options = {
            ...
            minZoom,
            maxZoom,
            source: constants_1.EMPTY_JSON_SOURCE,
            size: radius,
            style: strokeStyle,
        };
        return options;
    ...
    setSubLayersSource(source) {
        ...
        this.highlightStrokeLayer.changeData(constants_1.EMPTY_JSON_SOURCE);
        this.selectFillLayer.changeData(constants_1.EMPTY_JSON_SOURCE);
        this.selectStrokeLayer.changeData(constants_1.EMPTY_JSON_SOURCE);
    }
    /**
     * 设置高亮描边子图层数据
     */
    ...
    updateSubLayers(options) {
        ...
        // 标注图层
        this.labelLayer.update((0, label_layer_1.getLabelLayerOptions)(this.options), false);
        // 重置高亮/选中状态
...
exports.BubbleLayer = BubbleLayer;
/**
 * 默认配置项
 */
BubbleLayer.DefaultOptions = constants_2.DEFAULT_OPTIONS;
