...
import { DEFAULT_FLOW_LAYER_ACTIVE_OPTIONS, DEFAULT_FLOW_LAYER_SELECT_OPTIONS, DEFAULT_OPTIONS, EMPTY_CIRCLE_LAYER_SOURCE, EMPTY_LINE_LAYER_SOURCE, } from './constants';
...
export class FlowLayer extends CompositeLayer {
    constructor(options) {
         ...
         * 复合图层类型
         */
        this.type = CompositeLayer.LayerType.FlowLayer;
        /**
         * 数据计算中心
         */
    ...
    updateClusterState() {
        ...
        const currentBoundPolygon = bboxPolygon(scene.getBounds().flat());
        ...
        this.dataProviderState = Object.assign(Object.assign({}, this.options), { mapStatus: {
                zoom: scene.getZoom(),
                bounds: bbox(currentBoundPolygonScale),
            }, maxZoom,
            minZoom });
    }
    ...
    getLineLayerOptions() {
        ...
        if (this.dataProvider && this.scene) {
            ...
            if (this.circleLayer && options.style) {
                ...
                options.style.offsets = getLineOffsetsAttribute(clusterIndex, this.circleLayer);
            }
        }
        return options;
    }
    getLocationNameLayerOptions() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const originSource = Object.assign({}, showLocationName ? (_b = (_a = this.circleLayer) === null || _a === void 0 ? void 0 : _a.options['source']) !== null && _b !== void 0 ? _b : EMPTY_CIRCLE_LAYER_SOURCE : EMPTY_CIRCLE_LAYER_SOURCE);
            if (getClusterLocationName) {
                originSource.data = yield Promise.all(originSource.data.map((location, locationIndex) => __awaiter(this, void 0, void 0, function* () {
                    if (!location.name) {
                        try {
    ...
    _getFullActiveOptions() {
        var _a, _b;
        return Object.assign(Object.assign({}, DEFAULT_FLOW_LAYER_ACTIVE_OPTIONS), (((_a = this.options.state) === null || _a === void 0 ? void 0 : _a.active) instanceof Object ? (_b = this.options.state) === null || _b === void 0 ? void 0 : _b.active : {}));
    }
    _getFullSelectOptions() {
        var _a, _b;
        return Object.assign(Object.assign({}, DEFAULT_FLOW_LAYER_SELECT_OPTIONS), (((_a = this.options.state) === null || _a === void 0 ? void 0 : _a.select) instanceof Object ? (_b = this.options.state) === null || _b === void 0 ? void 0 : _b.select : {}));
    }
 ...
 * 默认配置项
 */
FlowLayer.DefaultOptions = DEFAULT_OPTIONS;
