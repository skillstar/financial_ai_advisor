...
export class ChoroplethLayer extends CompositeLayer {
    /**
     * 主图层
     */
    get layer() {
    ...
    constructor(options) {
         ...
         * 复合图层类型
         */
        this.type = CompositeLayer.LayerType.ChoroplethLayer;
        /**
         * 选中数据
         */
        this.selectData = [];
    ...
    createSubLayers() {
        ...
        // 映射填充面图层
        const fillLayer = new PolygonLayer(Object.assign(Object.assign({}, this.getFillLayerOptions()), { id: 'fillLayer', shape: 'fill', source, interaction: true }));
        // 描边图层
        const strokeLayer = new LineLayer(Object.assign(Object.assign({}, this.getStrokeLayerOptions()), { id: 'strokeLayer', shape: 'line', source }));
        // 高亮描边图层
        const highlightStrokeLayer = new LineLayer(Object.assign(Object.assign({}, this.getHighlightStrokeLayerOptions()), { id: 'highlightStrokeLayer' }));
        // 选中填充图层
        const selectFillLayer = new PolygonLayer(Object.assign(Object.assign({}, this.getSelectFillLayerOptions()), { id: 'selectFillLayer' }));
        // 选中描边图层
        const selectStrokeLayer = new LineLayer(Object.assign(Object.assign({}, this.getSelectStrokeLayerOptions()), { id: 'selectStrokeLayer' }));
        // 标注图层
        const labelLayer = new TextLayer(Object.assign(Object.assign({}, getLabelLayerOptions(this.options, source)), { id: 'labelLayer' }));
    ...
    getFillLayerOptions() {
        ...
        const _a = omit(this.options, ['source']), { visible, minZoom, maxZoom, zIndex = 0, fillColor, opacity } = _a, baseConfig = __rest(_a, ["visible", "minZoom", "maxZoom", "zIndex", "fillColor", "opacity"]);
    ...
    setSubLayersSource(source) {
        ...
        if (this.isSourceInstance(source)) {
            ...
            if (isLabelPosition((_a = this.options.label) === null || _a === void 0 ? void 0 : _a.position)) {
 ...
 * 默认配置项
 */
ChoroplethLayer.DefaultOptions = DEFAULT_OPTIONS;
