...
exports.getProgressConfig = void 0;
...
var getProgressConfig = exports.getProgressConfig = function getProgressConfig() {
  ...
  return matchingConfig ? [matchingConfig[1], 20].flat() : [_chalk["default"].green("\u2588"), _chalk["default"].bgWhite(' '), 40];
};