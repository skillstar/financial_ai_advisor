...
export var LineRender = /*#__PURE__*/function (_LayerRender) {
  function LineRender() {
    var _this;
  ...
  return _createClass(LineRender, [{
    ...
    value: function initLayers() {
      ...
      var layer = new LineLayer(options !== null && options !== void 0 ? options : {}).source(featureCollection([])).size('isHover*isActive', function (isHover, isActive) {
