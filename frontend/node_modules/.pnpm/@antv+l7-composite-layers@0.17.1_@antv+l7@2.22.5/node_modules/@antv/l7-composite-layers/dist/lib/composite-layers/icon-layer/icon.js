...
class IconLayer extends composite_layer_1.CompositeLayer {
    /**
     * 主图层
     */
    get layer() {
    ...
    constructor(options) {
         ...
         * 图层交互状态配置
         */
        this.layerState = constants_3.DEFAULT_STATE;
        /**
         * 复合图层类型
         */
    ...
    addTo(scene) {
        ...
        this.emit(constants_1.CompositeLayerEvent.ADD);
    }
    /**
     * 获取图标图层配置项
     */
    getIconLayerOptions() {
        var _a;
        const _b = (0, util_1.omit)(this.options, ['source']), { visible, minZoom, maxZoom, zIndex = 0, radius, opacity, icon, fillColor, iconStyle } = _b, baseConfig = tslib_1.__rest(_b, ["visible", "minZoom", "maxZoom", "zIndex", "radius", "opacity", "icon", "fillColor", "iconStyle"]);
        const fillState = {
    ...
    getHighLightLayerOptions() {
        ...
        const option = {
            visible: visible,
            blend: types_1.BlendType.normal,
            zIndex: zIndex + 0.1,
            minZoom,
            maxZoom,
            source: constants_2.EMPTY_JSON_SOURCE,
            size: radius,
            style: fillStyle,
    ...
    createSubLayers() {
        ...
        // 映射图标图层
        const iconLayer = new point_layer_1.PointLayer(Object.assign(Object.assign({}, this.getIconLayerOptions()), { id: 'iconLayer', source, interaction: true }));
        // 选中效果
        const selectLayer = new point_layer_1.PointLayer(Object.assign({ id: 'selectIconLayer' }, this.getHighLightLayerOptions()));
        // 文本标注
    ...
    updateSubLayers(options) {
        ...
        this.iconLabelLayer.update((0, label_layer_1.getLabelLayerOptions)(this.options), false);
    }
    /**
     * 设置选中描边与填充子图层数据
     */
    ...
    setSubLayersSource(source) {
        ...
        this.selectIconLayer.changeData(constants_2.EMPTY_JSON_SOURCE);
    }
    initSubLayersEvent() {
 ...
 * 默认配置项
 */
IconLayer.DefaultOptions = constants_3.DEFAULT_OPTIONS;
