  ...
  return _createClass(LineMode, [{
    ...
    value: function getDefaultOptions(options) {
      var newOptions = _objectSpread(_objectSpread({}, this.getCommonOptions(options)), {}, {
        ...
        dragOptions: (0, _lodash.cloneDeep)(_constant.DEFAULT_DRAG_OPTIONS)
      });
    ...
    value: function getAdsorbPosition(position) {
      ...
      return (0, _utils.getAdsorbPosition)({
    ...
    value: function handleLineDragging(line, _ref3) {
      ...
      nodes.forEach(function (node) {
        ...
        node.geometry.coordinates = [(0, _utils.getPrecisionNumber)(coordinates[0] + lng - preLng), (0, _utils.getPrecisionNumber)(coordinates[1] + lat - preLat)];
      });
    ...
    value: function onSceneDragStart(e) {
      ...
      this.sceneRender.on(_constant.RenderEvent.Dragging, this.onSceneDragging);
    }
  }, {
    key: "onSceneDragging",
    value: function onSceneDragging(e) {
      var drawLine = this.drawLine;
      var now = Date.now();
      var _DEFAULT_DRAG_OPTIONS = _objectSpread(_objectSpread({}, _constant.DEFAULT_DRAG_OPTIONS), this.options.dragOptions),
      ...
      var _getLngLat = (0, _utils.getLngLat)(e),
        currLng = _getLngLat.lng,
        currLat = _getLngLat.lat;
      var lastPosition = (0, _lodash.last)(drawLine.properties.nodes).geometry.coordinates;
    ...
    value: function unbindSceneDragEvent() {
      ...
      this.sceneRender.off(_constant.RenderEvent.Dragging, this.onSceneDragging);
