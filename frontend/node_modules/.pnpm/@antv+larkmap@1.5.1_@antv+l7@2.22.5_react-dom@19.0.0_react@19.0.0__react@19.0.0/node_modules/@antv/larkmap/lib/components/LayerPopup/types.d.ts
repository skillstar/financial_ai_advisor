...
export interface ILayerPopupConfigItem extends Omit<LayerPopupConfigItem, 'title' | 'customContent' | 'fields' | 'layer'> {
    title?: ReactNode | ((feature: any) => ReactNode);
    customContent?: ReactNode | ((feature: any) => ReactNode);
    fields?: (ILayerField | string)[];
    layer?: Layer | string;
}
export interface LayerPopupProps extends Omit<PopupProps, 'children' | 'followCursor' | 'title'>, Pick<ILayerPopupOption, 'trigger'> {
