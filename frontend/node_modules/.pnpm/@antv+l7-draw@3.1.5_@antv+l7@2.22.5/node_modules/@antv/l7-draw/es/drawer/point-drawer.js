...
import { getDefaultPointProperties, isSameFeature, joinMultiFeatures, splitMultiFeatures } from '../utils';
  ...
  return _createClass(PointDrawer, [{
    ...
    value: function setData(points) {
      this.setPointData(splitMultiFeatures(points).map(function (point) {
        point.properties = _objectSpread(_objectSpread({}, getDefaultPointProperties()), point.properties);
        return point;
      }));
    }
  }, {
